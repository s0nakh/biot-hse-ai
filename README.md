...
* ** ✅ Heatmap рисков 7×24:** Добавлена матрица визуализации инцидентов по часам и дням недели для выявления скрытых пиков опасности (например, пересменка или конец недели). Рекомендация (усилить надзор / внеплановый инструктаж).

&emsp;&emsp;На вкладке Аналитика — внизу страницы:
Матрица 7 строк (Пн–Вс) × 24 столбца (00–23ч). Каждая ячейка — реальные данные из Excel КМГ:

&emsp;&emsp;🔵 Синий = 1–2 инцидента<br>
&emsp;&emsp;🟡 Жёлтый = 3–5<br>
&emsp;&emsp;🔴 Красный = 6–8

&emsp;&emsp;Наведение мышкой на ячейку — появляется тултип с точным значением.

&emsp;&emsp;**Топ-3 пика из реальных данных КМГ:**<br>
&emsp;&emsp;Среда 15:00 — 8 инцидентов<br>
&emsp;&emsp;Понедельник 15:00 — 8 инцидентов<br>
&emsp;&emsp;Среда 14:00 — 7 инцидентов
...
* **✅ 7×24 Risk Heatmap:** Added an incident visualization matrix by hour and day of the week to identify hidden peak risks (e.g., shift changes or end-of-week fatigue). Includes actionable recommendations (e.g., "Step up supervision" / "Emergency safety briefing").

&emsp;&emsp;**Analytics Tab — Bottom of the Page:**
A 7x24 matrix (Mon–Sun × 00–23h) where each cell displays real data from the KMG dataset:

&emsp;&emsp;🔵 Blue = 1–2 incidents<br>
&emsp;&emsp;🟡 Yellow = 3–5 incidents<br>
&emsp;&emsp;🔴 Red = 6–8 incidents

&emsp;&emsp;Hovering over a cell triggers a tooltip with the exact value.

&emsp;&emsp;**Top 3 Peaks from Real KMG Data:**<br>
